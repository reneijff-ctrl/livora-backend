    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/webhooks/stripe", "/api/webhooks/stripe", "/api/stripe/webhook").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/tokens/packages").permitAll()
                .requestMatchers("/api/tokens/**").hasAnyRole("USER", "CREATOR")
