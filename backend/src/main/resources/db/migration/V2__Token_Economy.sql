...
CREATE INDEX IF NOT EXISTS idx_token_balance_user ON token_balances(user_id);
...
CREATE INDEX IF NOT EXISTS idx_creator_earning_user ON creator_earnings(user_id);
...
CREATE INDEX IF NOT EXISTS idx_tip_room ON tip_records(room_id);
CREATE INDEX IF NOT EXISTS idx_tip_viewer ON tip_records(viewer_id);
CREATE INDEX IF NOT EXISTS idx_tip_creator ON tip_records(creator_id);
